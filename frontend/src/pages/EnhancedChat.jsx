...
const EnhancedChat = () => {
  ...
  const fetchMessages = async (chatId) => {
    try {
      ...
      if (response.data.length > 0 && socket) {
        socket.emit('mark_as_read', {
          chatId: chatId,
          messageId: response.data[response.data.length - 1]._id
        });
      }
    } catch (err) {
                ...
                <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                </div>
              )}
